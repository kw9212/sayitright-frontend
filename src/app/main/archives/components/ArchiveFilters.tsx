...
export default function ArchiveFilters({ filters, onFiltersChange }: Props) {
  ...
  const hasActiveFilters =
    filters.tone || filters.relationship || filters.purpose || filters.from || filters.to;
        ...
        {hasActiveFilters && (
          <div className="flex-1 flex items-center gap-2 text-sm text-zinc-400">
            ...
            <div className="flex flex-wrap gap-2">
              {filters.tone && (
                <span className="px-2 py-1 bg-zinc-700 rounded text-xs">톤: {filters.tone}</span>
              )}
              {filters.relationship && (
                <span className="px-2 py-1 bg-zinc-700 rounded text-xs">
                  관계: {filters.relationship}
                </span>
              )}
              {filters.purpose && (
                <span className="px-2 py-1 bg-zinc-700 rounded text-xs">
              ...
              {(filters.from || filters.to) && (
                <span className="px-2 py-1 bg-zinc-700 rounded text-xs">기간 필터</span>
              )}
            </div>
          </div>
        )}
            ...
            <div className="md:col-span-2 lg:col-span-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 items-stretch sm:items-center">
                <input
                  ...
                  placeholder="시작일"
                  className="date-input-light flex-1 sm:max-w-[200px] px-3 py-2 bg-zinc-900 
                    border border-zinc-700 rounded-lg text-white focus:outline-none 
